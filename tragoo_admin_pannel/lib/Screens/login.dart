...
import 'package:tragoo_admin_pannel/Screens/signup.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  _loginFunction() async {
    ...
    User? user =
        await loginAuthServices.loginWithEmailAndPassword(email, pass, context);
    if (user != null) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: loginStyles.screenTitle('login'.tr),
                    ),
