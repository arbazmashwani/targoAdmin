...
import 'package:tragoo_admin_pannel/Screens/upload_profile.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  _signupFunction() {
    ...
    _firestor.collection('admin_details').add(
      {
        'email': gEmail,
         'name': gName
      }
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Align(
                          ...
                          child: signupStyles.screenTitle('signup'.tr)),
                    ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        signupStyles.customTextButton(
                          btnFunction: () {
                            Utilities.nextScreen(context, const LoginScreen());
                          },
                          btnText: "login".tr,
                        ),
                      ],
